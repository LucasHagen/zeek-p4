...
class UdpRequestOrReplyAnalyzer : public Analyzer {
public:
    UdpRequestOrReplyAnalyzer();
    ~UdpRequestOrReplyAnalyzer() override = default;

    static zeek::packet_analysis::AnalyzerPtr Instantiate() {
        return std::make_shared<UdpRequestOrReplyAnalyzer>();
    }
