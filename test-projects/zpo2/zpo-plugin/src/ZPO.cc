...
#include "rna.bif.h"	// Automatically generated from rna.bif

using namespace zeek::packet_analysis::RNAPlugin;

RNA::RNA()
	: zeek::packet_analysis::Analyzer("RNA")
{
}

bool RNA::AnalyzePacket(size_t len, const uint8_t* data, Packet* packet)
{
