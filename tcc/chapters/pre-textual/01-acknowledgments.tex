...
%     \mbox{}\vfill
%     {\sffamily\itshape
%       ``Não interessa qual o caminho que cada um escolheu,\\
%       nem como vocês vão fazer isso.
%       Mas façam com prazer, \\e gostem do que estiverem fazendo.
%       Pode ser que não ajude \\muito,
%       mas torna as coisas muito mais divertidas.''\\}
%     --- \textsc{Prof.~Dr.~Raul~Weber}
% \end{flushright}
